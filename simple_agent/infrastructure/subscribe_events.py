...
def subscribe_events(
    ...
    if app:
        ...
        event_bus.subscribe(UserPromptedEvent, lambda e: app.post_message(DomainEventMessage(e)))
        event_bus.subscribe(AssistantSaidEvent, lambda e: app.post_message(DomainEventMessage(e)))
